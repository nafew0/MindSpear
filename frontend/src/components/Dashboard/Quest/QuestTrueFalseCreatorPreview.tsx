...
const QuestTrueFalseCreatorPreview: React.FC<{ id: string }> = ({ id }) => {
	...
	console.log(
		currentItem,
		"currentItemcurrentItemcurrentItemcurrentItemcurrentItemcurrentItem"
	);
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-12 gap-5">
			<div className="md:col-span-9">
				<div className="flex-1 p-4 bg-white border-2 border-[#bc5eb3] rounded-lg h-[calc(90vh-80px)] flex flex-col justify-end overflow-y-auto scrollbar-hidden">
			...
			<div className="md:col-span-3 p-6 bg-white rounded-lg h-[calc(90vh-80px)] overflow-y-auto scrollbar-hidden">
				...
				<div className="flex gap-3 mb-6">
					<h3 className="block text-sm font-medium"> Question type : Yes / No </h3>
				</div>
...
export default QuestTrueFalseCreatorPreview;
