...
// import {
//   toggleSelectionMode,
// } from '@/services/redux/features/optionsSlice';
import {
	updateOptionText,
	updateOptionColor,
...
const FillInTheBlanksCreatorPreview: React.FC<QuizCreatorPreviewProps> = ({
	id,
}) => {
...
export default FillInTheBlanksCreatorPreview;
