...
const QuestshortingCreatorPreview: React.FC<{ id: string }> = ({ id }) => {
		...
		<div className="grid grid-cols-1 md:grid-cols-12 gap-5">
			...
			<div className="md:col-span-3 p-4 bg-white rounded-lg h-[calc(90vh-80px)] overflow-y-auto scrollbar-hidden">
				...
				<div className="flex gap-3 mb-6">
					<h3 className="block text-sm font-medium"> Question type : Sorting  </h3>
				</div>
...
export default QuestshortingCreatorPreview;
