...
const SurveyshortingCreatorPreview: React.FC<{ id: string }> = ({ id }) => {
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-12 gap-5">
			...
			<div className="md:col-span-3 shadow-md p-4 bg-white rounded-[15px] h-[calc(90vh-80px)] overflow-y-auto scrollbar-hidden">
				{" "}
				{/* Auto-save indicator */}
				...
				<Select
					...
					onChange={(value) =>
						actions.updateLimitedTimeTitle({ id, timeLimit: value })
					}
				/>
				{/* <Select
					className="mt-4 text-sm"
...
export default SurveyshortingCreatorPreview;
