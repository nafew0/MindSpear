...
class QuizSessionAttemptExportVertical implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    ...
    public function __construct(QuizSession $quizSession, $uniqueTasks)
    {
        ...
        $this->participants = $quizSession->participants;
    }
