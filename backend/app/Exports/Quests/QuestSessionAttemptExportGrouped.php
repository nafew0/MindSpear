...
class QuestSessionAttemptExportGrouped implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    ...
    public function collection()
    {
        ...
        foreach ($this->questSession->participants as $participant) {
