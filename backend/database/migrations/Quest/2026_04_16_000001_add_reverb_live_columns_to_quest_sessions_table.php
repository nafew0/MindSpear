...
return new class () extends Migration {
    public function up(): void
    {
        Schema::table('quest_sessions', function (Blueprint $table) {
            ...
            $table->foreignId('current_task_id')->nullable()->after('running_status')->constrained('quest_tasks')->nullOnDelete();
            $table->jsonb('timer_state')->nullable()->after('current_task_id');
        });
    ...
    public function down(): void
    {
        Schema::table('quest_sessions', function (Blueprint $table) {
            ...
            $table->dropColumn(['public_channel_key', 'current_task_id', 'timer_state']);
        });
    }
};
